...
export default function CustomerList() {
  ...
  // REMOVIDO: address do estado do form
  ...
  const openCreateModal = useCallback(() => {
    setEditingId(null);
    // REMOVIDO: address do reset do formulário
  ...
  const handleDelete = useCallback(
    async (id) => {
      ...
      if (error) {
        ...
        if (editingId === id) {
          setEditingId(null);
          // REMOVIDO: address do reset pós exclusão
          setForm({ name: "", email: "", phone: "" });
        }
        fetchCustomers();
      }
    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto border border-border rounded-md dark:bg-zinc-900">
          {/* Ajustado min-w para menos colunas, mas ainda para scroll horizontal */}
          <table className="w-full min-w-[600px] text-left">
            <thead>
              <tr>
                ...
                {/* REMOVIDO: Coluna de Endereço do cabeçalho da tabela */}
                <th
                  className="border-b border-border p-4 font-medium cursor-pointer select-none whitespace-nowrap"
